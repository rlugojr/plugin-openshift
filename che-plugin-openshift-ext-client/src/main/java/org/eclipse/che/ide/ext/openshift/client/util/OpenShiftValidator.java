...
public class OpenShiftValidator {
    ...
    private static final String LABEL_PREFIX = "[a-z0-9]([-a-z0-9]*[a-z0-9])?(\\\\.[a-z0-9]([-a-z0-9]*[a-z0-9])?)*";
    ...
    public static boolean isLabelValid(String label) {
        ...
        if (splitted.length == 2) {
            ...
            name = splitted[1];
            return !(Strings.isNullOrEmpty(prefix) || prefix.length() > 253 || !prefix.matches(LABEL_PREFIX)
